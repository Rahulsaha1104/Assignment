...
public class TestCoustomer {
	...
	public static void main(String[] args) {
		...
		Product product1 = new Product(1, "mobile", 100, 5);
        Product product2 = new Product(2, "watch", 100, 10);
        Product product3 = new Product(3, "Television", 100, 15);
        ...
        Customer customer=new Customer(1,"Rahul",Arrays.asList(order));
